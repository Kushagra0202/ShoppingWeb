...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <body style="background-color: aquamarine;">
        ...
        <div style="color: white; text-align: center; font-size: 30px; margin-top: 40px;">Deliverd <i class="fas fa-archive"></i></div>
    <table id="customers">
              <tr>
         ...
         try{
        	Class.forName("com.mysql.cj.jdbc.Driver");
         	...
         	ResultSet rs = st.executeQuery("select * from cart inner join product where cart.product_ID=product.product_ID and cart.order_Date is NOT NULL and cart.status='delivered'");
